...
/**
 * Created by lue on 03-06-2017.
 */

public class AdsAdapter extends BaseAdapter {
    private Context context;
    private LayoutInflater inflater;
    private List<pojo> movieItems;
//    ImageLoader imageLoader = AppController.getInstance().getImageLoader();



    public AdsAdapter(Context context ,List<pojo> movieItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = inflater.inflate(R.layout.showadslist, null);
...
//                imageLoader = AppController.getInstance().getImageLoader();
           ...
           // holder.genre = (TextView) convertView.findViewById(R.id.genre);
            ...
            pojo m = movieItems.get(position);
